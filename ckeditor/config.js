...
(function () {
  ...
  CKEDITOR.editorConfig = function (config) {
    ...
    (config.filebrowserBrowseUrl =
      "https://vnesports.vn/ckeditor/ckfinder/ckfinder.php"),
      (config.filebrowserUploadUrl =
        "https://vnesports.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files"),
      (config.filebrowserImageUploadUrl =
        "https://vnesports.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images"),
      (config.filebrowserFlashUploadUrl =
        "https://vnesports.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash"),
      // My Plugin
      /*/		
            config.plugins =
            // Plugin
